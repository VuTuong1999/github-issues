  ...
  return (
    <nav className="navbar">
      <div className="Nav">
        <div className="Nav-item">
          ...
          >
            <svg
              ...
              className="octicon octicon-menu-github v-align-middle"
            >
              <path
                fill-rule="evenodd"
        ...
        <div className="Nav-icon" class="mx-auto order-0">
        ...
        <div className="Nav-notifi">
          <a
            href="/notifications"
            class="Nav-item mr-0 mr-md-3 flex-order-1 flex-md-order-none"
            aria-label="You have no unread notifications"
            data-hotkey="g n"
            data-ga-click="Nav, go to notifications, icon:read"
            data-target="notification-indicator.link"
          >
            <span
              className="mail-status"
              data-target="notification-indicator.modifier"
            ></span>
            <svg
              aria-hidden="true"
              height="16"
